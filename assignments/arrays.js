...
consoleHeading("Challenge 1 - Recall information for call id 33 ");
...
consoleHeading("Challenge 2 - Information on the last car in the inventory");
let lastCar = 0;
...
// ==== Challenge 3 ====
// The marketing team wants the car models listed alphabetically on the website. Sort all the car model names into alphabetical
// order and log the results in the console
consoleHeading(
  "Challenge 3 - Car models listed alphabetically for the marketing team"
);
let carModels = [];
for (let i = 0; i < inventory.length; i++) {
...
consoleHeading(
  "Challenge 4 - Car years of every car on the lot for the accounting team. "
);
let carYears = [];
for (let i = 0; i < inventory.length; i++) {
...
consoleHeading("Challenge 5 - number of cars older than year 2000");
let oldCars = [];
...
consoleHeading("Challenge 6 - Array containing only the BMW and Audi Car. ");
let BMWAndAudi = [];
for (let i = 0; i < inventory.length; i++) {
  if (
...
var bmwaudiJSON = JSON.stringify(BMWAndAudi);
console.log(bmwaudiJSON);

function consoleHeading(challengeHeading) {
  console.log(
    "\n--------------------------------------------------------------------------"
  );
  console.log("\n***      " + challengeHeading + "     *********");
